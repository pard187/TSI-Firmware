...
void uart1_init(uint32_t baudrate) {
    ...
    U1STAbits.UTXEN = 1;
    U1STAbits.URXEN = 1;
    //    RPF5R = 0x1;  // connect U1TX to RPF5 - old board
    //    U1RXR = 0x2;  // connect U1RX to RPF4 - old board
    RPD11R = 0x1;  // connect U1TX to RPD11 - new board (TSI Rev. 7)
    U1RXR = 0x3;  // connect U1RX to RPD10 - new board (TSI Rev. 7)
