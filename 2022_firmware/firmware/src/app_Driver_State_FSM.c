...
If you are seeing this, hope you can comment your code in any of your projects. 
  ...
  Variable Key:
   ...
   Input Signals:
    saftyloop ? !RG6 (NOTE: safety_loop is a return condition "rc" and is different from the input saftyloop)
    MC_ACTIVATE ? calls mc_active() which calls get_NCD9830_reading(7) = MC+ and get_NCD9830_reading(6) = TSV --> access array NCD9830CH_READ[i]
    Drive_btn_pushing from app_drv_btn (RE1)
    throttleImplausibility ? RE6
    throttle (not on the schematic but used to get throttlepressed and throttlegreaterthan) ? calls get_ADCCh(0) from app_dataio.c --> calls DRV_ADC_SamplesRead(0) from drv_adc_static.c
    brakePressed ? !RE4
    overCurr ? Updates by interrupt at RPD1/FlowRate (RB7?), calls over_current() which uses get_NCD9830_reading(3) and get_NCD9830_reading(4)

   Output Signals:
    D_LED_CTRL (flashes in OVERCURRENT, needs replacement) ? RD0 (needs to
    Spare_LED_CTRL (ON in DRIVE state) ? RD11 
    Throttle_SEL ? RB8
    Cooling_Relay_CTRL ? RE7
    Buzzer (not actually declared in the code, value assigned directly)  ? RE0 


   Internal Signals:
    buzz_sound_count
    buzz_timer (Buzz_Cntr on the FSM diagram)
    nonCurrCntr
    throttlegreaterthan 
    throttlepressed 
...
/////////////////////////////////////////////////////////////////////////// TEST4 ///////////////////////////////////////////////////////////////////////////
    //PORTDbits.RD0 = ((0b00000100 & states) == 0b00000100);
/////////////////////////////////////////////////////////////////////////// TEST4 ///////////////////////////////////////////////////////////////////////////

    
/////////////////////////////////////////////////////////////////////////// TEST3 ///////////////////////////////////////////////////////////////////////////
    ////    PORTBbits.RB2 = ((0b00000100 & states) == 0b00000100);
    // PORTDbits.RD0 = ((0b00000011 & states) == 0b00000011);
/////////////////////////////////////////////////////////////////////////// TEST3 ///////////////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////////////// TEST2 ///////////////////////////////////////////////////////////////////////////
    //PORTDbits.RD0 = ((0b00000111 & states) == 0b00000100);
    //PORTDbits.RD0 = ((0b11111111 & states) == 0b00000001);
    //PORTDbits.RD0 = saftyloop;
    //delay_ms(10);
    //(0b00001111 & states) == 0b00001000 || (0b00001111 & states) == 0b00000011 || 
    //PORTDbits.RD1 = ((0b00000111 & states) == 0b00000100) ;
    //delay_ms(10);
    //PORTDbits.RD2 = ((0b00001111 & states) == 0b00001000);
/////////////////////////////////////////////////////////////////////////// TEST2 ///////////////////////////////////////////////////////////////////////////
    
/////////////////////////////////////////////////////////////////////////// TEST1 ///////////////////////////////////////////////////////////////////////////
    ////    PORTBbits.RB4 = ((0b00000001 & states) == 0b00000001);    
    // PORTDbits.RD0 = ((0b00000001 & states) == 0b00000001);
/////////////////////////////////////////////////////////////////////////// TEST1 ///////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////// TEST4 ///////////////////////////////////////////////////////////////////////////
            drive_btn_pushing = 1; // TEST
            brakePressed = 1;
            MC_Activate = 1;
            throttleImplausibility = 0;
            throttlepressed = 0;
            //PORTDbits.RD1 = drive_btn_pushing;
/////////////////////////////////////////////////////////////////////////// TEST4 ///////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////// TEST7 ///////////////////////////////////////////////////////////////////////////    
            PORTDbits.RD1 = 0;
            PORTDbits.RD2 = 1;
...
/////////////////////////////////////////////////////////////////////////// TEST7 ///////////////////////////////////////////////////////////////////////////    
            if(saftyloop == 0){
                ...
                // NOTE: Doesn't match w/ FSM. On FSM condition is (!drive_button_pushing && brakePressed)
                if (!throttlepressed) {
...
/////////////////////////////////////////////////////////////////////////// PRE-TEST ///////////////////////////////////////////////////////////////////////////
// INPUT TEST PINS
//        PORTCbits.RC14 = 1; // pin 10 on J3
//        PORTEbits.RE7 = 1; // pin 1 on J3
//        PORTBbits.RB7 = 1; // pin 9 on J3
//        PORTEbits.RE4 = 1; // white jumper

// OUTPUT TEST PINS - STATE_OUT LEDs
//    PORTDbits.RD0 = 1;
//    delay_ms(1);
//    PORTDbits.RD1 = 1;
//    delay_ms(1);
...
// NOT WORKING TEST PINS
//    PORTEbits.RE1 = 1;
//    PORTEbits.RE2 = 1; // old black jumper
//    PORTEbits.RE3 = 1; 
    //    PORTDbits.RD1 = 1;
    //    PORTDbits.RD2 = 1;
/////////////////////////////////////////////////////////////////////////// PRE-TEST ///////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////// CHANGE ///////////////////////////////////////////////////////////////////////////
    // PORTDbits.RD0 = D_LED_CTRL; // OLD
    PORTDbits.RD3 = D_LED_CTRL; // NEW
/////////////////////////////////////////////////////////////////////////// CHANGE ///////////////////////////////////////////////////////////////////////////
